	...
	throws ServletException, IOException {
	    ...
	    CustomerSql = 
	    	"select machineId,machineName,machineSpec,place,outCode," +
				...
				"machStandard,machManufacture,usedYears,machPrice,machOldRate,DE.deptname deptName," +
	    	...
	    	"left join machineType MT on MT.machineType=B.machType " +"left join dept DE on DE.deptid=B.dept_Id "+
	    ...
	    String jsonDate = "{\"cotent\":"+json+",\"no\":2000}";
	    System.out.println("天下第一"+jsonDate);
