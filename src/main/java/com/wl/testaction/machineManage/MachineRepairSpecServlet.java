...
public class MachineRepairSpecServlet extends HttpServlet {
	...
	throws ServletException, IOException {
	    ...
	    String pageNo = request.getParameter("pageIndex").trim();
	    String machineId = request.getParameter("machineId").trim();
	    String countPerPage = request.getParameter("pageSize").trim();
	    System.out.println("页码是:"+pageNo);
    	...
    	if(result.getEndDate().equals("9999-12-30")) {
    		result.setEndDate("");
    	}
		...
		request.setAttribute("pageSize", countPerPage);
