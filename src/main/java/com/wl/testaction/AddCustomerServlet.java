...
public class AddCustomerServlet extends HttpServlet {
	...
	throws ServletException, IOException {
		...
		String  addCustomerSql = "insert into customer " +
				...
				"ADVISE,ISTOGETHER,connector,connectorTel,connector2,connector2Tel,connector3,connector3Tel,connector4,connector4Tel,inout,alive )values('"+staffCode+"','"+
				companyId+"','"+companyName+"',to_date('"+foundingTime+"','yyyy-mm-dd,hh24:mi:ss'),'"+employeeNum+"','"
				+type+"','"+address+"','"+postCode+"','"+telephone+"','"+
				webAddress+"','"+header+"','"+business+"','"+advise+"','Y','"+connector+"','"+connectorTel+"','"+connector2+"','"+connector2Tel+"','"+connector3+"','"+connector3Tel+"','"+connector4+"','"+connector4Tel+"','"+inout+"',1)";
