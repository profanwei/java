...
//	private static  Logger log = Logger.getLogger(Sqlhelper.class);
	...
	public static List<Machine> returnMachine(String sql)throws SQLException{
		...
		try {
			...
			rs = ps.executeQuery();
             while(rs.next()) {     
            	...
            	machine.setText(rs.getString("text"));
            	 list.add(machine);            	 
             }
		} finally{
	...
	public static void insert1(String sql)throws SQLException{			
...
//	@Deprecated
	...
	public static List<List<String>> exeQueryList1(String sql) throws Exception{
		System.out.println(sql);
		List<List<String>> list=new ArrayList<List<String>>();
		List<String> machinename=new ArrayList<String>();
		List<String> machineid=new ArrayList<String>();
		try {
			conn = JdbcUtilsC3P0.getConnection();
			ps = conn.prepareStatement(sql);
			rs = ps.executeQuery();
	...
	public static String[] exeQueryStrings(String sql,String []params) throws Exception{
		System.out.println(sql);
		PrintArray.print(params);
