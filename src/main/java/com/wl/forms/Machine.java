...
//	private double checkTime;		
	...
	private String sumYuyueTime;
	private String sumcompletedtime;
	private String machinemanagers;
	private String workname;
	private String yujishiyong;
	...
	public String getyujishiyong() {
		return yujishiyong;
	}
	public void setyujishiyong(String yujishiyong) {
		this.yujishiyong = yujishiyong;
	}
	public String getshijishiyong() {
		return shijishiyong;
	}
	public void setshijishiyong(String shijishiyong) {
		this.shijishiyong = shijishiyong;
	}
	
	public String getsumYuyueTime() {
		return sumYuyueTime;
	}
	public void setsumYuyueTime(String sumYuyueTime) {
		this.sumYuyueTime = sumYuyueTime;
	}
	public String getsumcompletedtime() {
		return sumcompletedtime;
	}
	public void setsumcompletedtime(String sumcompletedtime) {
		this.sumcompletedtime = sumcompletedtime;
	}
	public String getmachinemanagers() {
		return machinemanagers;
	}
	public void setmachinemanagers(String machinemanagers) {
