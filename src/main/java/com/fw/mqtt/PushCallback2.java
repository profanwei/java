 ...
 */    
public class PushCallback2 implements MqttCallback,MqttCallbackExtended {
    ...
    public void messageArrived(String topic, MqttMessage message) throws Exception {
       ...
       if(!strs[0].equals("close")) {
    	   String sql="insert into MACHINE_5505 values ('";
	...
	public void connectComplete(boolean reconnect, String serverURI) {
		// TODO 自动生成的方法存根
		System.out.println("Fanuc连接成功");
		 try {
			Client2.getClient().subscribe("DataCollect/Fanuc/Machine_5505", 1);
