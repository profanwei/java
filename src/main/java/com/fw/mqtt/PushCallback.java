...
public class PushCallback implements MqttCallback,MqttCallbackExtended {
    ...
    public void messageArrived(String topic, MqttMessage message) throws Exception {
      ...
      String []strs=payload.split(",",-1); //字符分割 
       ...
       if(!strs[0].equals("close")) {
    	   String sql="insert into MACHINE_5503 values ('";
	...
	public void connectComplete(boolean reconnect, String serverURI) {
		...
		System.out.println("DMG连接成功");
		System.out.println(Client.getClient().getClientId());		
		 try {
			Client.getClient().subscribe("DataCollect/DMG/Machine_5503", 1);
