...
public interface SysuserMapper {
	...
	public HashMap<String,String> panduanMachineManagerMapper(@Param("staffCode") String staffCode, @Param("staffName") String staffName,@Param("machineId") String machineId);
	/**
	 * @param machineId
	 * @return
	 */
