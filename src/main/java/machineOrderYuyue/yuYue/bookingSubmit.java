		...
		System.out.println(bookings);
		 ...
		 for(JSONObject booking:bookings){
			...
			/* int machineId=Integer.parseInt(booking.getString("siteId")); */
			 System.out.println(booking.getString("siteId"));
			 String machineId=booking.getString("siteId");
			 ...
			 String panduan="select count(*)from bookinginfo where orderid='"+ orderId +"'and unid='"+unid+"'";
			 try {
				 String[] param2 =null;
				count=	Sqlhelper.exeQueryCountNum(panduan, param2);
