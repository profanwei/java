...
<li>
<h3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;加工数量</h3>
<p><input id="productNum"  name="productNum" class="mini-textbox"  width="100%" value="1" required="true"  vtype="int"/></p>
</li>
<li>
<h3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;材料</h3>
   			...
   			var staffCode="<%=((User)request.getSession().getAttribute("user")).getStaffCode()%>";
   				...
   				jQuery.ajax({
		  				...
		  				success: function (dat) {
		  					  mini.get("companyName").setValue(dat.companyId);
		  					  mini.get("companyName").setText(dat.companyName);
		                     mini.get("connector").setValue(dat.connector);
		                     mini.get("connectorTel").setValue(dat.connectorTel);
		                     var pre=dat.companyId+"-"+nowRight+"-";
		 		          	  var params = {'companyId':dat.companyId,'pre':pre};
		                     var url='CheckOrderIdCountServlet'; 
		                     jQuery.post(url, params, function(wo){
		                     text=mini.decode(wo);
		                     total=text.total+1;
		          /*            if(total>0&&total<10)
		                     total="0"+total;
		                     ...
		                     total="01"; */
		 					   mini.get("orderId").setValue(dat.companyId+"-"+nowRight+"-"+total);
		 				          });
		  				},
		  				error:function(data){
