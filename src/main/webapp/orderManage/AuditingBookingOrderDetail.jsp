  	...
  	<div class="mini-toolbar" style="padding:2px;border:0;">
       ...
       <td class="labelTd"><label for="checkAdvice$text">预约审核意见</label></td>
	        <td colspan="5"><input id="checkAdvice" name="checkAdvice" class="mini-textarea" emptyText="请输入审核意见"  style="height:100%;width:100%" borderStyle="border:0"/></td>
   	      ...
   	      <div id="bookMachine" class="mini-datagrid" style="width:100%;height:650px;" 
        url="myBookOrderMachine1.action?orderId=<%=request.getParameter("orderId")%>" idField="id" 
        allowResize="true" pageSize="200" 
        allowCellEdit="true" allowCellSelect="true" multiSelect="true" 
        editNextOnEnterKey="true"  editNextRowCell="true"  sizeList	="[100,200,500]" showHeader="true" onheadercellclick="headerclick">
        <div property="columns">
            ...
            <div name="timeYmd" field="timeYmd" width="100" align="center" headerAlign="center" dateFormat="yyyy-MM-dd">日期
          	...
          	<div name="startTimeInfo"  field="startTimeInfo"  headerAlign="center" align="center" allowSort="false" width="150" >开始时间
                <input property="editor" class="mini-textbox" style="width:100%;" minWidth="200" />
            </div>
            
            <div name="endTimeInfo"  field="endTimeInfo"  headerAlign="center"  allowSort="false" align="center" width="150" >结束时间
                <input property="editor" class="mini-textbox" style="width:100%;" minWidth="200" />
            </div>
            <div type="comboboxcolumn" autoShowPopup="true" name="isPass" field="isPass" width="200"  alowSrot="false" hideable="true" align="center" headerAlign="center" renderer="onPassRenderer"  >是否通过
	       ...
	       <div name="isPassAdvice"  field="isPassAdvice"  headerAlign="center"  allowSort="false" allowCellWrap="true" align="center" width="150">请输入审核意见
	              <input property="editor" class="mini-textbox" style="width:100%;" minWidth="100" minHeight="50"/>
	            </div>
	            
	       <div name="staffName"  field="staffName"  headerAlign="center"  allowSort="false" align="center" width="100">审核人
	              <input property="editor" class="mini-textbox" style="width:100%;" minWidth="100" minHeight="50" allowinput="false"/>
	            </div>
    ...
    <script type="text/javascript">
	   ...
	   function headerclick(e){
	    ...
	    function saveAuditAdvice() {
			    ...
			    var json = eval("("+data01+")");
				console.log("nihao"+data01);
			 
			    for(var i=0;i<json.length;i++)
			    	{ 
			    	var ps=json[i].isPass;
			    	console.log(ps);
			    	if(ps==''){
			    		 mini.alert("尚未审核", "提示",function(){
			 ...
			 $.ajax({
                ...
                data:{list:data01,orderId:orderId,createtime:createtime},
                success:function(text){
                	grid.load();
               	 	/* alert(mini.decode(text).result);  */
               	 	    mini.alert("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"+mini.decode(text).result, "提示",function(){
	   ...
	   // var Genders = [{id: "11", text: "新建"},{id: "12", text: "备料"},{id: "13", text: "代加工"},{id: "14", text: "加工中"},{id: "15", text: "完成"}];
        ...
        { if (e.value==""||e.value==null) {
        	return e.row.isPass="否";
    	}else{
    		
    		return e.row.isPass=e.value
    	}}
        
        
          if (e.value==""||e.value==null) {
                	return e.row.isPass="是";
                	}else{
