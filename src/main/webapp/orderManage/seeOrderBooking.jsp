    ...
    <article>
	    ...
	    <table style="margin-left:15px;font-size:8px" >
	   		<tr>
	   		  ...
	   		  <td><span>&nbsp;</span></td>
	          <td>开始</td>
	          <td><input id="bday" class="mini-datepicker" width="70"  allowinput="false"  format="yyyy-MM-dd" required="true"/>
	          </td>
	          <td>结束</td>
	          <td><input id="eday" class="mini-datepicker"  width="70" allowinput="false"  format="yyyy-MM-dd" required="true"/>
	          </td>
	          <td><span>&nbsp;</span></td>
                                                            ...
                                                            <ul class="unstyled overflow text-right m-n p-n pull-right">
                                                               ...
                                                               <li class="pull-left text-right m-r-md">
                                                                   ...
                                                                   <li class="pull-left text-right">
                                                                    <img class="m-r-xs"
                                                                         src="<%=path %>/resource/images/scene.png">预定成功
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="article_2"><!-- 方框 -->
                                                        <div class="scrollBox"><!-- 方框开始 -->
                                                            <div class="box-scroll" id="session_container">
                                                                <script  type="text/html" id="session_tmpl">
...
//                     console.log(JSON.stringify(data));
    ...
    function LoadBookOrder(){
    	...
    	bookOrder.load({"orderId":orderId,"sign":"yuyue"});
    }
    ...
    function onSelectionChanged(e) {
       ...
       <%-- "/SSM/resource/datelines.txt",  "<%=path %>/load", --%>
         ...
         dataType: "json",
         success: function(data){
        	 var deptId=data.content.deptId;
    ...
    function setGridBoxSize() {
        ...
        var totalcount=count*gridWid
        $(".box-list").width(totalcount);
...
//                alert(JSON.stringify(data));
		...
		function back(){
			...
			window.location.href="MyBookOrder.jsp?pageSize="+pageSize+"&pageIndex="+pageIndex+"&status="+status;
		}
</script>
</body>
