...
<script type="text/javascript">
	...
	<a class="mini-button" iconCls="icon-node" showCloseButton="false" url="orderManage/totalMachineOrder">15号楼实验室</a>
	<a class="mini-button" iconCls="icon-node" showCloseButton="false" url="">17号楼实验室</a>
	<a class="mini-button" iconCls="icon-node" showCloseButton="false" url="">4号楼实验室</a>
	</div> -->
