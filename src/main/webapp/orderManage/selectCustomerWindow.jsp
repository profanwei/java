  ...
  <body>
    ...
    <div class="mini-fit">
		...
		<td><input value="查询" type="button" onclick="search()"/></td>
		  	 <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;是否校内客户：</td>
	          <td><input id="inoutstatus" name="inoutstatus" class="mini-combobox" width="200" textName="" textField="text" valueField="id"
        ...
        <div id="grid1" class="mini-datagrid" style="width:100%;height:90%;" idField="id" allowResize="true"
            borderStyle="border-left:0;border-right:0;" onrowdblclick="onRowDblClick" url="ShowCustomerInfoServlet"
        >
...
<!-- 	            <div field="address" width="100" headerAlign="center">详细地址</div> -->
            	...
            	<div field="connectorTel" width="100" headerAlign="center">联系人电话</div>          
            	  <div field="inout" width="100" headerAlign="center" align="center" renderer="onRenderer">是否校内客户
            </div> 
            </div>
        </div>
...
<script type="text/javascript">
    ...
    function search(){
    	...
    	inout=mini.get("inoutstatus").getValue();
    	grid.load({customerName:customerName,inout:inout});
