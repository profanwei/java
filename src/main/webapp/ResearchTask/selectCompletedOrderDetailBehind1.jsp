...
<!--             <div name="orderId" field="orderId" width="100"  >订单号
  ...
  <div field="totalTime" width="100"  align="center" headerAlign="center">设备上报时间/h</div>
              <div field="totalTime1" width="100"  align="center" headerAlign="center">上报总时间/h</div>
              <div  name="machineStatus"  field="machineStatus"   headerAlign="center"  allowSort="false" width="50" align="center" headerAlign="center" >设备状态

                

            </div>
                 <div name="comments"  field="comments"   headerAlign="center"  allowSort="false" width="70" align="center" headerAlign="center" >故障描述
...
<!--           <div field="completedRemarks"  name="completedRemarks" width="120" headerAlign="center" >备注
      ...
      <script type="text/javascript">
       ...
       function onLoad(e) {
           ...
           var marges=[];
           marges.push(
                   {rowIndex: 0, columnIndex:7, rowSpan:len, colSpan: 0});

           for(i;i<len;i++){
                   if(i==len-1 ){
                  var k=i+1-num;
                  //动态添加合并的参数，rowIndex开始行数(0开始)，columnIndex列数(0开始)，rowSpan合并的行数，colSpan合并的列数
                 marges.push({rowIndex: k, columnIndex:2, rowSpan: num, colSpan: 0},
