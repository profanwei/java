...
<!--    <input id="key" class="mini-textbox" emptyText="请输入订单号" style="width:250px;" onenter="onKeyEnter"/>   
		...
		<a class="mini-button" iconCls="icon-find" plain="false" onclick="pass('16')">审核通过</a>
		<span class="separator"></span> 
	
		<a class="mini-button" iconCls="icon-find" plain="false" onclick="pass('13')">退回修改</a>
		<span class="separator"></span> 
...
<div id="form1">
        ...
        <tr>
         ...
         <!--    
            ...
            <td><input id="completedStaffName"  name="completedStaffName" class="mini-textbox" style="width:100%;"    enabled="false" readonly="readonly" value="<%=((User)session.getAttribute("user")).getUserName() %>" "/>
    	    </td>
             <td colspan="4">
             </td>
    	     </tr>
      ...
      <script type="text/javascript">
        ...
        var completedStaffName="<%=((User)session.getAttribute("user")).getUserName() %>";
        var bookStatus;
        ...
        function loadForm(orderId) {
            ...
            $.ajax({
                ...
                success: function (text) {
                    ...
                    completedAdvice=data.completedAdvice;
                    console.log(completedAdvice);
                    form.setData(eval('(' + text + ')'));  
                    mini.get("completedStaffName").setValue(completedStaffName);
