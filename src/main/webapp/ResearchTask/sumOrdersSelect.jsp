	       ...
	       <tr>
	         - <td>订单状态：</td>
	          <td><input id="bookStatus" name="bookStatus" class="mini-combobox" width="100" textName="" textField="text" valueField="id"
  				url="data/bookStatus.txt"  allowInput="false" showNullItem="true" nullItemText="全部订单"  onvaluechanged="loadgrid"/>
	          </td> 
	   		  <td align="right">客户：</td>
	          <td colspan="2"><input id="companyName" name="companyId" class="mini-buttonedit" width="100%" showClose="true" oncloseclick="onCloseClick('companyName')"
...
<!-- 	</div> -->
    ...
    <div id="grid1" class="mini-datagrid" style="width:100%;height:85%;"
         ...
         url="mybookOrder.action" allowCellSelect="true" allowCellEdit="true" sortField="createTime" >
        ...
        <div field="orderId" width="50" allowSort="true" headerAlign="center" align="center">订单编号
            ...
            <div field="bookStatus" width="60" headerAlign="center" align="center" renderer="onGenderRenderer">状态
            ...
            <div field="connectorTel" width="30" headerAlign="center" align="center" >联系人电话
                          ...
                          <div field="productNum" width="50" headerAlign="center" align="center" >数量
             </div>
            
            <div field="createTime" width="60" headerAlign="center"  allowSort="true"dateFormat="yyyy-MM-dd HH:mm:ss" align="center" >创建时间
            </div>
                <div field="material" width="50" headerAlign="center" align="center" >材料
             </div>
            <div field="bookStatus" width="60" headerAlign="center" align="center" renderer="onGenderRenderer">状态
    ...
    $(function(){
    	...
    	if("${param.company}"!=""){
    		mini.get('companyName').setValue("${param.company}");
    		mini.get('companyName').setText("${param.companyNo}");
    		loadgrid();
    	}	
	    ...
	    var bookGenders=[{id: "0", text: "已删除"},{id: "11", text: "待预约"},{id: "12", text: "预约待审核"},{id: "12.5", text: "预约审核中"},{id: "13", text: "待上报"},{id: "14", text: "预约不通过"},{id: "15", text: "上报待审核"},{id: "16", text: "订单完结"}]
...
//          str += "</span>";
		...
		function ondMenu(orderId,companyName,connectorTel,deptUser,bookStatus,createTime,connector){
	        ...
	        var company=mini.get('companyName').getValue();
	        var companyNo=mini.get('companyName').getText();
	        console.log(companyNo);

			//var createTime=document.getElementById("createTime");
	    	window.location="ResearchTask/selectCompletedOrderDetail.jsp?orderId="+orderId+"&companyName="+companyName+"&connector="+connector+"&connectorTel="+connectorTel+"&deptUser="+deptUser+"&bookStatus="+bookStatus+"&createTime="+createTime+"&pageSize="+pageSize+"&pageIndex="+pageIndex+"&status="+status+"&company="+company+"&companyNo="+companyNo;
		}
