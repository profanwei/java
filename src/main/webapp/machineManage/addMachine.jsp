	   		...
	   		<tr>
	            ...
	            <td><label for="machType$text">设备类别</label></td>
	   			<td><input id="machType"  name="machType" class="mini-combobox" style="width:100%;" textField="typeName" valueField="machineType" emptyText="请选择..."
    				url="GetMachTypeServlet"   required="true" allowInput="false" showNullItem="true" nullItemText="请选择..."/>  
            	</td>
	       ...
	       <tr style="display:none">
	   		...
	   		<tr>
            	...
            	<td><label for="isKeyMach$text">工时费率</label></td>
	   			<td><input id="isKeyMach"  name="isKeyMach" class="mini-textbox" style="width:100%;" textField="text" valueField="id" emptyText="每小时价格/元"
