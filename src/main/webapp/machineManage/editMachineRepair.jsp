		...
		<legend>设备维修信息</legend>
	   	<div id= "userdiv">
	   		...
	   		<tr>
	            ...
	            <td><input id="machineName"  name="machineName" class="mini-textbox"  width="100%" required="true"  value='${result.machineName}' enabled="false"/></td>
	       ...
	       <tr>
	   		...
	   		<tr>
		    	...
		    	<td><input id="mainId" name="mainId" class="mini-textbox" width="100%"  enabled="false" required="true" text="${result.mainId}"  value="${result.mainId}" }/></td>
	        </tr>
	   		<tr height="60px;">
...
/*             s.setValue(new Date()); */
   		...
   		function back(){
			...
			window.location.href="machineManage/MachineRepairBack.jsp?pageSize="+${pageSize}+"&pageIndex="+${pageNo}+"&machineId="+machineId;
		}
