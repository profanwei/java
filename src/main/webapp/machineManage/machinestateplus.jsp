...
<body> 
	   	<div id= "machinestate" style="width:920px;height:500px;">
	   		...
	   		<div style="width:49%; float:left;">
	   		<h3>102实验室</h3>
	   		<table style="height:400px;text-align: left;border-collapse:collapse;" border="gray 2px solid;">
	   		<tr>
	           <td>
...
<script type="text/javascript">
		...
		var beginTime10 =0;
		var beginTime11 =0;
		var clientid='<%=((User)session.getAttribute("user")).getStaffCode() %>'+Math.random();
