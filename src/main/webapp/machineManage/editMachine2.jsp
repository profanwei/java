   				...
   				<tr>
		            ...
		            <td><input id="machineName"  name="machineName" class="mini-textbox"  width="100%" required="true"  value='${result.machineName}'/></td>
		   			...
		   			<td><input id="machType"  name="machType" class="mini-combobox" style="width:100%;" textField="typeName" valueField="machineType" emptyText="请选择..."
	    				url="GetMachTypeServlet"   required="true" allowInput="false" showNullItem="true" nullItemText="请选择..." value='${result.machType}'/>  
	            	</td>
		       </tr>
		       <tr>
		   		...
		   		<tr>
			        ...
			        <td><input id="workRange"  name="workRange" class="mini-textbox" width="100%" required="false" value='${result.workRange}' /></td>
		   			<td><label for="machineSpec$text">控制系统</label></td>
		   		...
		   		<tr>
		   		            	<td><label for="isKeyMach$text">工时费率</label></td>
	   			<td><input id="isKeyMach"  name="isKeyMach" class="mini-textbox" style="width:100%;" textField="text" valueField="id" emptyText="每小时价格/元"  value='${result.isKeyMach}'
	...
	<%-- 	   			<td><label for="isKeyMach$text">是否关键设备</label></td>
		   		...
		   		<tr>
		            ...
		            <td><input id="power"  name="power" class="mini-textbox" width="100%" vtype="float" required="false"  value='${result.power}'/></td>
		   			<td><label for="deptId$text">放置地点</label></td>
		   			<td><input id="deptId" name="deptId" class="mini-buttonedit" width="100%" onbuttonclick="onButtonEdit"  required="true" value='${result.deptId}' text='${result.deptName}'/></td>
