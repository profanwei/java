  ...
  <body>
    ...
    <div id="grid1" class="mini-datagrid" style="width:100%;height:95%;"
        ...
        <div property="columns">
            ...
            <div field="machineId" width="80" headerAlign="center" align="center">设备编号</div>
            <div field="machineName" width="80" headerAlign="center" align="center">设备名称</div>
            <div field="machineSpec" width="80" headerAlign="center" align="center">控制系统</div>
            <div field="typeName" width="80" headerAlign="center" align="center">设备类别</div>
            <div field="machModel" width="80" headerAlign="center" align="center">设备型号</div>
            <div field="machStandard" width="80" headerAlign="center" align="center">设备品牌</div>
            <div field="machPrice" name="machPrice" width="60" headerAlign="center" align="center" renderer="onRenderer1">设备价格</div>
<!--              <div field="hourPercent" width="80" headerAlign="center">工时百分比</div>
            <div field="countPercent" width="80" headerAlign="center">计件百分比</div> --> 
            <div field="outDate" width="100" headerAlign="center" dateFormat="yyyy-MM-dd" align="center">出厂日期</div>
            <div field="deptName" width="100" headerAlign="center" align="center">放置地点</div>
            <div field="isKeyMach" name="isKeyMach" width="80" headerAlign="center"  align="center" renderer="onRenderer">工时费率（元）</div> 
        </div>
    </div>
    ...
    <script type="text/javascript">
        ...
        function onRenderer(e) {
            if (e.value=="0") {
         	return e.row.isKeyMach="";
     }
            else{
         	   return  e.row.isKeyMach=e.value;
            }
     }
        function onRenderer1(e) {
            if (e.value=="0") {
         	return e.row.machPrice="";
     }
            else{
         	   return  e.row.machPrice=e.value;
            }
     }
	    ...
	    function ondEdit(machineId){
	        window.location.href = "MachineSpecServlet2?machineId="+machineId;
		}
