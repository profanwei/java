...
<style type="text/css">
    	...
    	input{width:100px;height:20px;line-height:30px;}
    	.zhuangtai{
    	float:left;
    	}
    	img{
...
<body> 
	   	<div id= "machinestate" style="width:920px;height:500px;">
	           ...
	           <div id="images"><img src="resources/images/DHHCX.jpg" />
					...
					<div id="101" class="circle1"></div>
	           </div><br>
	           	<div class="zhuangtai"><h4>数控电火花成形机床</h4><br><br>
	          	 <p><span >开机时间</span><input type="text" value="" id="beginTime1" name="beginTime1"/></p>
				 <p><span >运行时间</span><input type="text" value="" id="runTime1" name="runTime1"/></p></div>
				</td>
				<td>
	           <div><img src="resources/images/CJMCX.jpg" />
	           		<div id="203" class="circle3"></div>
					<div id="202" class="circle2"></div>
					<div id="201" class="circle1"></div>
	           </div><br/>
	           	<div class="zhuangtai"><h4>超精密成形平面磨床</h4><br><br>
	          	 <p><span >开机时间</span><input type="text" value="" id="beginTime2" name="beginTime2" /></p>
				 <p><span >运行时间</span><input type="text" value="" id="runTime2" name="runTime2" /></p></div>
				</td>
			</tr>
	   		<tr>
	   			<td>
	           <div><img src="resources/images/DSZS.jpg" />
					...
					<div id="301" class="circle1"></div>
	           </div><br/>
	           	<div class="zhuangtai"><h4>数控低速走丝电火花线切割</h4><br><br>
	          	 <p><span >开机时间</span><input type="text" value="" id="beginTime3" name="beginTime3" /></p>
				 <p><span >运行时间</span><input type="text" value="" id="runTime3" name="runTime3" /></p></div>
				</td>
				<td>
	           <div><img src="resources/images/SKCC.jpg" />
	          	    <div id="403" class="circle3"></div>
					<div id="402" class="circle2"></div>
					<div id="401" class="circle1"></div>
	           </div><br/>
	           	<div class="zhuangtai"><h4>数控车床</h4><br><br>
	          	 <p><span >开机时间</span><input type="text" value="" id="beginTime4" name="beginTime4" /></p>
				 <p><span >运行时间</span><input type="text" value="" id="runTime4" name="runTime4" /></p></div>
				</td>
			</tr>
	           ...
	           <div><img src="resources/images/SKGSCXMC.jpg" />
					...
					<div id="501" class="circle1"></div>
	           
	           </div><br/>
	           	<div class="zhuangtai"><h4>数控高速成形磨床</h4><br><br>
	          	 <p><span >开机时间</span><input type="text" value="" id="beginTime5" name="beginTime5" /></p>
				 <p><span >运行时间</span><input type="text" value="" id="runTime5" name="runTime5" /></p></div>
	           ...
	           <div><img src="resources/images/CNC.jpg" />
					...
					<div id="601" class="circle1"></div>
	           </div><br/>
	           	<div class="zhuangtai"><h4>CNC雕刻机</h4><br><br>
	          	 <p><span >开机时间</span><input type="text" value="" id="beginTime6" name="beginTime6" /></p>
				 <p><span >运行时间</span><input type="text" value="" id="runTime6" name="runTime6" /></p></div>
				</td>
			</tr>
	           ...
	           <div><img src="resources/images/CXFH.jpg" />
					...
					<div id="701" class="circle1"></div>
	           </div><br/>
	           	<div class="zhuangtai"><h4>车铣复合加工中心</h4><br><br>
	          	 <p><span >开机时间</span><input type="text" value="" id="beginTime7" name="beginTime7" /></p>
				 <p><span >运行时间</span><input type="text" value="" id="runTime7" name="runTime7" /></p></div>
				</td>
				<td>
	           <div><img src="resources/images/GSWZB.jpg" />
	         	  	<div id="803" class="circle3"></div>
					<div id="802" class="circle2"></div>
					<div id="801" class="circle1"></div>
	           </div><br/>
	           	<div class="zhuangtai"><h4>高速五坐标加工中心</h4><br><br>
	          	 <p><span >开机时间</span><input type="text" value="" id="beginTime8" name="beginTime8" /></p>
				 <p><span >运行时间</span><input type="text" value="" id="runTime8" name="runTime8" /></p></div>
				</td>
			</tr>
	   		<tr>
	   			<td>
	           <div><img src="resources/images/chaogaosumo.jpg" />
					...
					<div id="901" class="circle1"></div>
	           </div><br/>
	           	<div class="zhuangtai"><h4>超高速磨床</h4><br><br>
	          	 <p><span >开机时间</span><input type="text" value="" id="beginTime9" name="beginTime9" /></p>
				 <p><span >运行时间</span><input type="text" value="" id="runTime9" name="runTime9" /></p></div>
				</td>
				<td>
	           <div><img src="resources/images/JGZX.jpg" />
	           		<div id="1003" class="circle3"></div>
					<div id="1002" class="circle2"></div>
					<div id="1001" class="circle1"></div>
	           </div><br/>
	           	<div class="zhuangtai"><h4>倒立式车削加工中心</h4><br><br>
	          	 <p><span >开机时间</span><input type="text" value="" id="beginTime10" name="beginTime10" /></p>
				 <p><span >运行时间</span><input type="text" value="" id="runTime10" name="runTime10" /></p></div>
				</td>
			</tr>
	           ...
	           <div><img src="resources/images/CSFZ1.jpg" />
					...
					<div id="1101" class="circle1"></div>
	           </div><br/>
	           	<div class="zhuangtai"><h4>超声辅助高速加工中心</h4><br><br>
	          	 <p><span >开机时间</span><input type="text" value="" id="beginTime11" name="beginTime11" /></p>
				 <p><span >运行时间</span><input type="text" value="" id="runTime11" name="runTime11" /></p></div>
				</td>
			<td>
