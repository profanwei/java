...
#diyHeader .mini-panel-header{
      color:white;
        height:45px;
        padding-top:12px;
        background-image: url("<%=path %>/staticResources/image/color.jpg"); 
...
<div class="navbar">
    ...
    <ul class="nav navbar-nav navbar-right">
        ...
        <li ><a href="javascript:changepd()"><i class="fa fa-pencil-square-o"></i> 修改密码</a></li>  <!-- EditSysUsersServlet?para=0 -->
        <li class="dropdown">
            <a class="dropdown-toggle userinfo">
                <img class="user-img" src="resources/frame1/res/images/user.jpg" /><%=((User)session.getAttribute("user")).getUserName() %><i class="fa fa-angle-down"></i>
            </a>
            <ul class="dropdown-menu pull-right">
                <li ><a href="sysUserManage/personalInfoManagement1.jsp" ><i class="fa fa-eye"></i> 用户信息</a></li>
...
function changepd(){
    ...
    mini.open({
        url: "sysUserManage/changepd.jsp",
        title: "<font size='4px'  font weight='bold' >修改密码</div>",
        id:"diyHeader",
        width: 360,
        height: 650,
