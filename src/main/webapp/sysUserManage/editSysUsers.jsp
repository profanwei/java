...
<html>
  ...
  <body>
    ...
    float: none;;" align="center">
		<legend>
			注册用户
		</legend>
   	<div id= "userdiv">
   		<table style="text-align: left;border-collapse:collapse;margin: 0 auto;" border="gray 1px solid;"  width="100%" >
   		<tr>
   			<td><label for="userId$text">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp用户号</label></td>
            <td><input id="userId"  name="userId" class="mini-textbox" width="100%" required="true" value="${result.userId}" enabled="false" /></td>
   			<td><label for="staffCode$text">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp员工号</label></td>
...
<!--        	     <td><label for="authority$text">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp权限</label></td>
 --><%--             <td><input id="authority" name="authority" class="mini-combobox" style="width:100%;" textField="authorityName" valueField="authorityId" emptyText="请选择..."
       	...
       	<tr>
       		...
       		<td><label for="Confirmpassword$text">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp密码确认</label></td>
   ...
   <script>
   			...
   			mini.confirm("当前用户密码将被重置为123", "确定？",
                function (action){            
                  if (action == "ok") {
	                ...
	                var url = 'DoEditSysUsersServlet1?para=1';		//参数1 表示重置密码
   		...
   		function getForm(){
            ...
            if (form.isValid() == false) {
            	...
            	var data = form.getData();
                var params = eval("("+mini.encode(data)+")");
                var url = 'DoEditSysUsersServlet1';
   		        jQuery.post(url, params, function(data){
