 ...
 width:120px;
  ...
  <body>
        ...
        <td width="25%"></td>
			...
			<sapn class="mini-toolbar" style="margin-left:730px;border:0;margin-top;-80px;width:100px;">
		<input id="edit"type="button" value="修改" onclick="onEdit()"/>

   		 </span>
			<span class="mini" style="margin-left:85px;border:0;margin-top;-80px;width:100px;">
		<input id="back"type="button" value="返回"   onclick="javascript:window.location.href='MyMainJsp.jsp'"/>
