	...
	<fieldset style="width: 100%;" align="center">
   	...
   	<div id= "userdiv">
        ...
        <tr>
            ...
            <td><input id="inout"  name="inout" class="mini-combobox"  width="100%"   value="${customer.inout}" url="data/inout.txt" textField="text" valueField="id" required="true" allowInput="false" showNullItem="true" nullItemText="请选择..."/></td>
   		...
   		<tr>
            ...
            <td ><input id="advise"  name="advise" class="mini-textbox" width="100%"  value="${customer.advise}"/></td>
...
<%--    		<tr>
   ...
   <script>
   		...
   		function getForm(isTogether){
   			...
   			var s=mini.get("companyName").getValue().trim();
   			console.log(s.indexOf(" "))
   			var b=mini.get("connector").getValue().trim();
   			console.log(b)
