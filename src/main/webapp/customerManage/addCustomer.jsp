  ...
  <div class="mini-toolbar">
	...
	<fieldset style="width: 100%;" align="center">
   	...
   	<div id= "userdiv">
   		...
   		<tr>
            ...
            <td><input id="companyId"  name="companyId" class="mini-textbox" emptyText="不必填写，此项自动生成！" width="100%"  required="true" allowInput="false" enabled="false"/></td>
       ...
       <tr>
	        ...
	        <td><label for="inout$text">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;是否内部客户</label></td>
            <td><input id="inout"  name="inout" class="mini-combobox"  width="100%" text="是" value="1" url="data/inout.txt" textField="text" valueField="id" required="true" allowInput="false" showNullItem="true" nullItemText="请选择..."/></td>
		</tr>
   		<tr>
   ...
   <script>
   		...
   		function getForm(){
   			...
   			var b=mini.get("connector").getValue();
   			if (s.indexOf(" ") >=0||b.indexOf(" ") >=0) {
   				mini.alert("禁止含有空格","提示",function(){
   	 ...
   	 var inoutgender=[{id: "1", text: "是"},{id: "2", text: "否"}]
